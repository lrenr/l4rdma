...
void create_and_bind_irq(l4_uint32_t irq_num, L4::Cap<L4::Irq>& irq, L4::Cap<L4::Icu>& icu, L4::Cap<L4::Thread> thread);

pthread_t create_msix_irq(l4_uint64_t icu_src, volatile l4_uint32_t* msix_table,
