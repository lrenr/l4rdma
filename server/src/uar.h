...
typedef PA::Page_Pool<UAR_PPM, UAR_BM, UAR_PM> UAR_Page_Pool;
typedef PA::Page_Block<UAR_BM, UAR_PM> UAR_Page_Block;
typedef PA::Page<UAR_BM, UAR_PM> UAR_Page;
